        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <Link key={f.t} href={`/${f.t.toLowerCase().replace(' ', '-')}`} className="card group transition hover:shadow-xl">
      ...
      <section className="bg-slate-50 py-20 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            {[
              { i: Sparkles, l: 'G\'oya', c: 'text-violet-500', h: '/ai/idea' }, { i: TrendingUp, l: 'Biznes-plan', c: 'text-pink-500', h: '/ai/business' },
              { i: Code, l: 'Kod', c: 'text-blue-500', h: '/ai/code' }, { i: FileText, l: 'Rezyume', c: 'text-green-500', h: '/ai/resume' },
              { i: Globe, l: 'Tarjima', c: 'text-orange-500', h: '/ai/translate' }, { i: FileText, l: 'Blog', c: 'text-red-500', h: '/ai/blog' },
              { i: MessageCircle, l: 'Email', c: 'text-cyan-500', h: '/ai/email' }, { i: Users, l: 'Pitch', c: 'text-amber-500', h: '/ai/pitch' },
              { i: Crown, l: 'Brend', c: 'text-rose-500', h: '/ai/brand' }, { i: Sparkles, l: 'Boshqalar', c: 'text-violet-500', h: '/ai' },
            ].map((t) => (
              <Link key={t.l} href={t.h} className="card flex flex-col items-center gap-2 p-3 text-center transition hover:shadow-md">
          ...
          <div className="mx-auto grid max-w-5xl gap-4 md:grid-cols-3">
            {[
              ...
              <div key={p.n} className={`card relative ${p.popular ? 'border-violet-500 ring-2 ring-violet-500' : ''}`}>
                ...
                <Link href="/auth/register"><Button variant={p.popular ? 'gradient' : 'outline'} fullWidth className="mt-4">
